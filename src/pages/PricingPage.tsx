...
const PricingPage = () => {
  ...
  const faqs = [
    {
      ...
      a: "Yes, you can upgrade or downgrade your plan at any time. If you upgrade, you'll be prorated for the remaining time on your current billing cycle.",
    },

    {
      q: "How does the annual discount work?",
      a: "By choosing annual billing, you pay for 10 months upfront and get 2 months entirely free. It's automatically applied when you select the 'Yearly' billing toggle.",
    },

    {
      q: "Are there any hidden egress or bandwidth fees?",
      a: "No hidden fees. If you exceed your plan's bandwidth allocation, we charge a flat, transparent rate of $0.01 per GB globally.",
    },

    {
      q: "What payment methods do you accept?",
      a: "We accept all major credit cards (Visa, Mastercard, Amex), PayPal, and wire transfers for Enterprise annual contracts.",
    },

    {
      q: "Can I pay in PKR locally?",
      a: "Yes! We support local bank transfers and local card payments in Pakistani Rupees without additional conversion charges.",
    },
  ]
  ...
  const tableFeatures = [
    ...
    {
      name: "Load Balancers",
      tiers: ["Optional Add-on", "1 Included", "Unlimited"],
    },
...

    {
      ...
      tiers: ["Add-on ($5/mo)", "Included (Daily)", "Included (Hourly)"],
    },
      ...
      <header className="bg-dark-base text-white pt-20 pb-48 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-body-lg text-neutral-400 mb-10 max-w-2xl mx-auto">
            No hidden egress fees, no complex calculators. Predictable pricing
            designed to scale alongside your business.
          </p>
                ...
                <span
                  className={`px-2 py-0.5 rounded text-xs ${
                    isAnnual
                      ...
                      : "bg-success/30 text-success-light"
                  }`}
                >
                  Save 20%
                </span>
            ...
            {tiers.map((tier, idx) => (
              ...
              >
                ...
                <div className="p-8 border-b border-neutral-100">
                  ...
                  <p className="text-sm text-neutral-500 h-10 mb-6">
                    {tier.desc}
                  </p>
                  ...
                  {isAnnual && (
                    <div className="mt-2 text-sm font-medium text-success">
                      Billed annually ({getSymbol()}
                      {(currency === "USD"
                        ? tier.priceUSD.annual
                        : tier.priceUSD.annual * exchangeRate
                      ).toLocaleString()}
                      )
                    </div>
                  )}
                ...
                <div className="p-8 flex-grow flex flex-col">
                      ...
                      <li key={fIdx} className="flex items-start gap-3">
                        ...
                        <span
                          className={`text-sm font-medium ${
                            feat.inc ? "text-neutral-700" : "text-neutral-400"
                          }`}
                        >
                          {feat.name}
                        </span>
                  ...
                  <button
                    className={`w-full px-5 py-3.5 rounded-lg font-semibold text-base transition-all flex items-center justify-center gap-2 ${
                      tier.popular
            ...
            {[
              {
                ...
                price: "$0.10 / GB",
                desc: "Attach high-speed block storage volumes instantly.",
              },

              {
                ...
                title: "Dedicated IP",
                price: "$5 / mo",
                desc: "Reserved static IPv4 addresses for your instances.",
              },

              {
                icon: <RefreshCw className="w-6 h-6" />,
                title: "Automated Backups",
                price: "+20% of instance",
                desc: "Daily snapshots with 7-day automated retention.",
              },

              {
                ...
                price: "$99 / mo",
                desc: "Guaranteed 4-hour response time and architecture reviews.",
              },
            ].map((addon, idx) => (
              <div
                key={idx}
                className="bg-light-base rounded-xl p-6 border border-neutral-200 hover:border-primary/50 transition-colors"
              >
                  ...
                  {tableFeatures.map((row, idx) => {
                    if (row.category) {
                      return (
                        <tr
                          key={idx}
                          className="bg-neutral-50/80 border-y border-neutral-200"
                        >
                          <td
                            colSpan={4}
                            className="p-4 font-bold text-neutral-900 uppercase tracking-wider text-xs"
                          >
                            {row.category}
                          </td>
                        </tr>
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-3xl p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-sm">
            <div className="text-center md:text-left">
              ...
              <p className="text-body-lg text-neutral-300 max-w-xl">
                For massive scale, specific compliance requirements, or custom
                SLAs, our enterprise architects can build a solution tailored to
                your exact needs.
              </p>
            </div>
