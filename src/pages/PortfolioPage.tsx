...
import { 
  ...
  Globe, Terminal, Briefcase, ArrowRight, 
  Quote, TrendingUp, DollarSign, Clock, Users,
  CheckCircle2, Building2, Stethoscope, ShoppingCart, 
  GraduationCap
} from 'lucide-react';
    ...
    <div className="flex items-center gap-8 container-custom w-full max-w-[1200px] mx-auto">
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => setPage('portfolio')}>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button onClick={() => setPage('portfolio')} className="px-4 py-2 text-sm font-medium text-white transition-colors rounded-md bg-white/10 flex items-center gap-1">
...
const CTABanner = () => (
  <section className="py-24 bg-primary relative overflow-hidden">
    ...
    <div className="container-custom relative z-10 text-center text-white">
      <h2 className="text-h2 mb-6 max-w-2xl mx-auto">Ready to be our next success story?</h2>
      <p className="text-body-lg text-white/80 mb-10 max-w-xl mx-auto">
        Join industry leaders who have transformed their infrastructure and reduced costs with XB Cloud Tech.
      </p>
...
const PortfolioPage = ({ setPage }: { setPage: (page: string) => void }) => {
  ...
  const filteredStudies = activeFilter === 'All' ? caseStudies : caseStudies.filter(s => s.industry === activeFilter);

  return (
    <div className="min-h-screen bg-light-base flex flex-col font-sans text-neutral-900">
      ...
      <header className="bg-dark-base text-white pt-20 pb-16 relative">
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          <p className="text-body-lg text-neutral-400 mb-0 max-w-2xl mx-auto">
            Discover how leading organizations are leveraging our infrastructure to scale faster, optimize costs, and secure their data.
          </p>
        </div>
      </header>
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-3xl overflow-hidden shadow-2xl grid grid-cols-1 lg:grid-cols-2">
            <div className="p-10 md:p-14 flex flex-col justify-center relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-8">
                <div className="px-3 py-1 rounded-full bg-primary/20 text-secondary text-xs font-semibold uppercase tracking-wider">Featured Story</div>
                <div className="px-3 py-1 rounded-full border border-white/10 text-neutral-300 text-xs font-semibold uppercase tracking-wider">SaaS Platform</div>
              </div>
              
              <h2 className="text-h2 text-white mb-6 leading-tight">DataStack scaled to 1M daily users while cutting cloud costs by 60%.</h2>
              ...
              <div className="grid grid-cols-2 gap-6 mb-10 border-y border-white/10 py-6">
                <div>
                  ...
                  <div className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">Cost Reduction</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-success mb-1">99.999%</div>
                  <div className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">Uptime Achieved</div>
                </div>
              </div>
              ...
              <blockquote className="text-lg text-neutral-300 italic mb-8 relative">
                ...
                "Moving our primary workloads to XB Cloud Tech was the best engineering decision we made this year. The performance is unparalleled, and we don't have to worry about exorbitant egress fees."
              </blockquote>
              
              <div>
                <button onClick={() => setPage('portfolio-detail')} className="px-6 py-3 bg-white text-dark-base rounded-lg font-bold text-sm transition-all hover:bg-neutral-200 flex items-center gap-2">
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filteredStudies.map((study) => (
              <div key={study.id} className="bg-white rounded-2xl border border-neutral-200 shadow-sm hover:shadow-lg hover:border-primary/30 transition-all group overflow-hidden flex flex-col cursor-pointer" onClick={() => setPage('portfolio-detail')}>
                <div className="h-64 overflow-hidden relative">
                  <div className="absolute inset-0 bg-dark-base/20 group-hover:bg-transparent transition-colors z-10"></div>
                  <img src={study.img} alt={study.client} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute top-4 left-4 z-20 flex items-center gap-2 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-sm">
                    ...
                    <span className="font-bold text-neutral-900 text-sm">{study.client}</span>
                  </div>
                </div>
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <h3 className="text-h3 text-neutral-900 mb-3">{study.result}</h3>
                  <p className="text-body text-neutral-500 mb-8 flex-grow">{study.desc}</p>
      ...
      <section className="py-24 bg-white border-y border-neutral-200">
        <div className="container-custom text-center">
          <h3 className="text-caption text-neutral-400 mb-12">TRUSTED BY INNOVATIVE TEAMS WORLDWIDE</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center justify-items-center opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-2 text-neutral-500 hover:text-neutral-900 transition-colors cursor-pointer">
                {logo.icon}
...
const PortfolioDetailPage = ({ setPage }: { setPage: (page: string) => void }) => {
  return (
    <div className="min-h-screen bg-light-base flex flex-col font-sans text-neutral-900 selection:bg-primary/20">
      ...
      <header className="bg-dark-base text-white pt-16 pb-24 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="flex items-center text-sm font-medium text-neutral-400 mb-12 space-x-2">
            ...
            <span className="hover:text-white transition-colors cursor-pointer" onClick={() => setPage('portfolio')}>Success Stories</span>
            <ChevronRight className="w-4 h-4" />
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-neutral-400 font-medium">Global E-commerce Retailer</div>
                </div>
              </div>
              
              <h1 className="text-h1 mb-6">Handling a 5x Black Friday traffic surge with zero downtime.</h1>
              <p className="text-body-lg text-neutral-400 mb-8">
                How migrating to managed Kubernetes on XB Cloud Tech enabled ShopGlobal to automatically scale their infrastructure to meet unprecedented holiday demand.
              </p>
              
              <div className="flex flex-wrap gap-6 border-t border-white/10 pt-6">
                <div>
                  <div className="text-xs text-neutral-500 font-semibold uppercase tracking-wider mb-1">Industry</div>
                  <div className="font-medium">Retail & E-commerce</div>
                </div>
                <div>
                  <div className="text-xs text-neutral-500 font-semibold uppercase tracking-wider mb-1">Project Duration</div>
                  <div className="font-medium">3 Months</div>
                </div>
                <div>
                  <div className="text-xs text-neutral-500 font-semibold uppercase tracking-wider mb-1">Services Used</div>
                  <div className="font-medium text-secondary">Managed Kubernetes, Edge CDN</div>
                </div>
              </div>
            </div>
            
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10">
              <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?q=80&w=1200&auto=format&fit=crop" alt="E-commerce Dashboard" className="w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-neutral-100 text-center">
            <div className="px-4">
              ...
              <div className="text-sm font-semibold text-neutral-500 uppercase tracking-wider">Uptime Maintained</div>
            </div>
            <div className="px-4">
              <div className="text-4xl lg:text-5xl font-bold text-success mb-2">5x</div>
              <div className="text-sm font-semibold text-neutral-500 uppercase tracking-wider">Traffic Surge Handled</div>
            </div>
            <div className="px-4">
              <div className="text-4xl lg:text-5xl font-bold text-primary mb-2">40%</div>
              <div className="text-sm font-semibold text-neutral-500 uppercase tracking-wider">Reduction in Cloud Spend</div>
            </div>
            <div className="px-4">
              <div className="text-4xl lg:text-5xl font-bold text-neutral-900 mb-2">2 min</div>
              <div className="text-sm font-semibold text-neutral-500 uppercase tracking-wider">Auto-scaling latency</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom max-w-4xl mx-auto space-y-20">
          ...
          <div className="bg-white p-10 md:p-14 rounded-3xl border border-neutral-200 shadow-sm relative overflow-hidden">
            ...
            <div className="prose prose-lg text-neutral-600 space-y-6">
              <p>
                As a rapidly growing global retailer, ShopGlobal experienced massive seasonal traffic spikes, particularly during the Black Friday/Cyber Monday (BFCM) weekend. Their previous infrastructure, hosted on a legacy monolithic architecture, required manual capacity provisioning months in advance.
              </p>
              <p>
                If they provisioned too much, they wasted hundreds of thousands of dollars on idle compute. If they provisioned too little, the site would crash—as it did the previous year, costing an estimated $2.4M in lost revenue in just 45 minutes of downtime.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-10 md:p-14 rounded-3xl border border-neutral-200 shadow-sm relative overflow-hidden">
            ...
            <div className="prose prose-lg text-neutral-600 space-y-6">
              <p>
                ShopGlobal's engineering team partnered with XB Cloud Tech to modernize their stack. We migrated their monolithic application to a microservices architecture running on our <strong>Managed Kubernetes (K8s)</strong> platform.
              </p>
              <ul className="space-y-4 my-8 pl-4">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-primary mt-1 shrink-0" />
                  <span><strong>Horizontal Pod Autoscaling (HPA):</strong> Configured to automatically spin up new pods within seconds based on CPU utilization and incoming HTTP requests.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-primary mt-1 shrink-0" />
                  <span><strong>Global Edge CDN:</strong> Implemented across 32 Edge locations to cache static assets, dramatically reducing the load on the origin servers.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-6 h-6 text-primary mt-1 shrink-0" />
                  <span><strong>Managed PostgreSQL:</strong> Utilized high-availability read-replicas to handle the massive surge in database read queries for product catalogs.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-dark-base text-white p-10 md:p-14 rounded-3xl relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <blockquote className="text-2xl md:text-3xl font-medium leading-relaxed mb-10">
                "We watched the live traffic analytics hit 5x our normal peak on Black Friday. The Kubernetes clusters auto-scaled beautifully in real-time. Our engineers didn't have to touch a thing—they just watched the dashboard and drank coffee."
              </blockquote>
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-neutral-800 overflow-hidden border-2 border-white/20">
                  <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?q=80&w=200&auto=format&fit=crop" alt="CTO" className="w-full h-full object-cover" />
                </div>
                <div>
                  <div className="font-bold text-lg">Marcus Chen</div>
                  <div className="text-secondary font-medium text-sm">Chief Technology Officer, ShopGlobal</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-10 md:p-14 rounded-3xl border border-neutral-200 shadow-sm relative overflow-hidden">
            ...
            <div className="prose prose-lg text-neutral-600 space-y-6">
              <p>
                The Black Friday weekend was the most successful in company history. Despite experiencing a sustained 5x surge in traffic over 72 hours, the application maintained 100% uptime with sub-second page load speeds globally.
              </p>
              <p>
                Because the infrastructure scaled back down automatically after the weekend, ShopGlobal achieved a 40% reduction in their overall monthly cloud spend compared to their previous legacy setup.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-white border-t border-neutral-200">
        <div className="container-custom">
          <h2 className="text-h3 mb-10 text-neutral-900">More Success Stories</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { client: 'MediCore Health', industry: 'Healthcare', desc: '100% HIPAA Compliance achieved with 0 data breaches.' },
              { client: 'FinEdge Capital', industry: 'Finance', desc: 'Reduced trading latency by 45 milliseconds globally.' },
              { client: 'LearnSphere', industry: 'Education', desc: 'Cut monthly infrastructure costs by 40% via microservices.' }
            ].map((study, idx) => (
              <div key={idx} className="group cursor-pointer bg-light-base rounded-2xl p-8 border border-neutral-200 hover:border-primary/50 hover:shadow-lg transition-all flex flex-col" onClick={() => setPage('portfolio-detail')}>
                <div className="mb-4">
                ...
                <h4 className="text-xl font-bold text-neutral-900 mb-3">{study.client}</h4>
                <p className="text-sm text-neutral-500 mb-6 flex-grow">{study.desc}</p>
                <span className="text-sm font-semibold text-primary flex items-center gap-1 group-hover:gap-2 transition-all">Read story <ArrowRight className="w-4 h-4" /></span>
              </div>
            ))}
          </div>
        </div>
...
const App = () => {
  ...
  if (currentPage === 'portfolio') {
    return <PortfolioPage setPage={setCurrentPage} />;
  }
  
  if (currentPage === 'portfolio-detail') {
    return <PortfolioDetailPage setPage={setCurrentPage} />;
  }
  ...
  return (
    <div className="p-8">
      ...
      <button onClick={() => setCurrentPage('portfolio')} className="mt-4 px-4 py-2 bg-primary text-white rounded">Go to Case Studies</button>
    </div>
  );
};
