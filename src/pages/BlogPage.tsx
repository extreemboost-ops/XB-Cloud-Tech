      ...
      <div className="bg-primary/10 border border-primary/20 rounded-3xl p-10 md:p-14 flex flex-col lg:flex-row items-center justify-between gap-10 backdrop-blur-sm">
        <div className="text-center lg:text-left max-w-xl">
          ...
          <p className="text-neutral-300">
            Get the latest cloud engineering tutorials, architecture guides, and
            platform updates delivered straight to your inbox every two weeks.
          </p>
        </div>
...
const BlogPage = () => {
  ...
  const posts = [
    {
      ...
      excerpt:
        "Learn the foundational principles for designing robust, fault-tolerant distributed systems on modern cloud infrastructure.",
...

    {
      ...
      excerpt:
        "Moving beyond the perimeter. How to implement zero-trust network policies inside your Kubernetes clusters.",
...

    {
      ...
      excerpt:
        "Tired of waiting for builds? Here is exactly how our internal engineering team optimized our deployment pipelines.",
...

    {
      ...
      excerpt:
        "A step-by-step tutorial on writing a cronjob to dump your database and securely transfer it to immutable object storage.",
  ...
  const popularPosts = [
    ...
    {
      title: "Choosing between Bare Metal and Virtualized Compute",
      date: "Jul 22, 2026",
    },

    {
      title: "How to monitor Kubernetes at scale with Prometheus",
      date: "Jun 30, 2026",
    },
  ]
      ...
      <header className="bg-white border-b border-neutral-200 pt-16 pb-16">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h1 className="text-h1 mb-4 text-neutral-900">
                Insights & Resources
              </h1>
              <p className="text-body-lg text-neutral-500 max-w-xl">
                Engineering deep dives, product updates, and tutorials to help
                you build and scale better software.
              </p>
            </div>
              ...
              <div className="p-8 md:p-10">
                <div className="flex items-center gap-4 text-sm text-neutral-500 font-medium mb-4">
                  ...
                  <span className="flex items-center gap-1.5">
                    <Calendar className="w-4 h-4" /> Oct 18, 2026
                  </span>
                </div>
                ...
                <p className="text-body-lg text-neutral-500 mb-8">
                  Today we are thrilled to announce our next generation of
                  compute instances, featuring the latest AMD EPYC processors
                  and a completely re-architected hypervisor layer that improves
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-dark-base rounded-2xl border border-neutral-900 p-8 text-white shadow-xl relative overflow-hidden">
            ...
            <p className="text-sm text-neutral-400 mb-6">
              Get $100 in free credits to spin up your first cluster in seconds.
            </p>
          ...
          <div className="bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm">
            <h4 className="font-bold text-lg text-neutral-900 mb-6">
              Categories
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={idx}>
                  <a
                    href="#"
                    className="text-sm font-medium text-neutral-600 hover:text-primary transition-colors flex items-center justify-between"
                  >
                    {cat.split(" (")[0]}
                    <span className="bg-neutral-100 text-neutral-500 px-2 py-0.5 rounded-full text-xs">
                      {cat.split("(")[1].replace(")", "")}
                    </span>
                  </a>
                </li>
    ...
    <div className="bg-light-base flex flex-col font-sans text-neutral-900 selection:bg-primary/20">
        ...
        <div className="container-custom max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-4 text-sm font-medium text-neutral-500">
              <span className="flex items-center gap-1.5">
                <Calendar className="w-4 h-4" /> Sep 28, 2026
              </span>
              <span className="flex items-center gap-1.5">
      ...
      <div className="container-custom max-w-5xl mx-auto -mt-6 z-10 relative">
        <div className="aspect-[21/9] rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
          <img
            src="https://images.unsplash.com/photo-1618401471353-b98afee0b2eb?q=80&w=2000&auto=format&fit=crop"
            alt="Server rack"
            className="w-full h-full object-cover"
          />
        </div>
        ...
        <div className="container-custom max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <article className="lg:col-span-8 bg-white p-8 md:p-12 rounded-3xl border border-neutral-200 shadow-sm prose prose-lg prose-neutral max-w-none prose-headings:font-bold prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h3:text-2xl prose-p:text-neutral-600 prose-p:leading-relaxed prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
            <p className="text-xl text-neutral-700 font-medium leading-relaxed">
              If your engineering team is merging code 10 times a day, but
              waiting 25 minutes for CI/CD pipelines to finish running, you are
              bleeding engineering hours.
            </p>
            <p>
              In this post, we'll walk through exactly how our internal
              infrastructure team identified bottlenecks in our deployment
              pipelines and re-architected our Github Actions + Kubernetes flow
              to reduce average build times from 22 minutes to just under 13
              minutes.
            </p>

            <h2>The Bottleneck: Docker Build Contexts</h2>
            <p>
              The most significant time-sink we found was in the Docker build
              step. Our monolithic repository had grown significantly, and the
              daemon was sending massive build contexts on every commit.
            </p>

            <blockquote>
              "Optimization isn't about working faster; it's about removing the
              friction that stops you from working at all."
            </blockquote>

            <p>
              We implemented a two-fold solution using buildkit caching and
              multi-stage builds.
            </p>

            <h3>1. Multi-stage Builds</h3>
            <p>
              By separating the compilation environment from the runtime
              environment, we not only reduced the final image size but
              significantly improved caching layers.
            </p>
            ...
            <div className="bg-[#1E2433] rounded-xl overflow-hidden my-8 not-prose shadow-lg">
              <div className="bg-[#111520] px-4 py-2 flex items-center gap-2 border-b border-white/10">
                ...
                <div className="text-xs text-neutral-400 font-mono ml-2">
                  Dockerfile
                </div>
              </div>
              <pre className="p-4 text-sm font-mono text-neutral-300 overflow-x-auto leading-relaxed">
                <code className="language-dockerfile">
                  <span className="text-neutral-500"># Stage 1: Build</span>
                  <br />
                  <span className="text-secondary">FROM</span> node:18-alpine{" "}
                  <span className="text-secondary">AS</span> builder
                  <br />
                  <span className="text-secondary">WORKDIR</span> /app
                  <br />
                  <span className="text-secondary">COPY</span> package*.json ./
                  <br />
                  <span className="text-secondary">RUN</span> npm ci
                  <br />
                  <span className="text-secondary">COPY</span> . .<br />
                  <span className="text-secondary">RUN</span> npm run build
                  <br />
                  <br />
                  <span className="text-neutral-500"># Stage 2: Runtime</span>
                  <br />
                  <span className="text-secondary">FROM</span> node:18-alpine
                  <br />
                  <span className="text-secondary">WORKDIR</span> /app
                  <br />
                  <span className="text-secondary">COPY</span> --from=builder
                  /app/dist ./dist
                  <br />
                  <span className="text-secondary">CMD</span> ["node",
                  "dist/main.js"]
                </code>
              </pre>
            </div>
            ...
            <p>
              We moved to aggressively caching `node_modules` across Github
              Action runs. If the `package-lock.json` hash doesn't change, we
              skip the `npm install` step entirely.
            </p>
            <p>
              This single change shaved 4 minutes off every build that only
              included source code changes.
            </p>
            ...
            <div className="lg:hidden flex items-center gap-4 mb-8 pt-4">
              ...
              <button className="w-10 h-10 rounded-full bg-light-base flex items-center justify-center text-neutral-600">
                <MessageCircle className="w-4 h-4" />
              </button>
              <button className="w-10 h-10 rounded-full bg-light-base flex items-center justify-center text-neutral-600">
                <Briefcase className="w-4 h-4" />
            ...
            <div className="bg-light-base rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-6 border border-neutral-100 not-prose">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-sm text-neutral-600">
                  Marcus leads the global infrastructure team at XB Cloud Tech.
                  Prior to joining, he spent 8 years scaling distributed
                  databases at major tech companies. He writes about DevOps,
                  observability, and team culture.
                </p>
              </div>
            </div>
          </article>
          ...
          <div className="hidden lg:block lg:col-span-3">
            <div className="sticky top-[100px] bg-dark-base rounded-2xl border border-neutral-900 p-8 text-white shadow-xl relative overflow-hidden">
              ...
              <p className="text-sm text-neutral-400 mb-6">
                Our Kubernetes clusters are optimized out-of-the-box for CI/CD
                integration.
              </p>
        ...
        <div className="container-custom max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 border border-neutral-100 shadow-sm">
              ...
              <p className="text-sm text-neutral-600">
                Great writeup. Did you guys consider using Buildah instead of
                Docker for the CI environment to avoid the daemon overhead
                completely?
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-neutral-100 shadow-sm ml-12 border-l-2 border-l-primary/30">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <div className="text-sm font-bold text-neutral-900">
                    Marcus Johnson{" "}
                    <span className="bg-primary/10 text-primary px-1.5 py-0.5 rounded text-[10px] ml-1 uppercase">
                      Author
                    </span>
                  </div>
              ...
              <p className="text-sm text-neutral-600">
                Yes! We actually evaluated Buildah and Kaniko. We ended up
                sticking with Docker Buildx due to better caching integration
                with our specific Github Actions runner setup, but Kaniko is on
                our radar for a future iteration.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
...

              {
                title: "Choosing between Bare Metal and Virtualized Compute",
                cat: "Cloud Tips",
                img: "https://images.unsplash.com/photo-1620283085068-5aab14e8ac0c?q=80&w=800&auto=format&fit=crop",
              },
            ].map((post, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h4 className="text-lg font-bold text-neutral-900 mb-3 group-hover:text-primary transition-colors leading-tight">
                    {post.title}
                  </h4>
                  <span className="text-sm font-semibold text-neutral-600 flex items-center gap-1 group-hover:text-primary group-hover:gap-2 transition-all">
