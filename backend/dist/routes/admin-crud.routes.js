...
export async function registerAdminCrudRoutes(app) {
    app.get('/admin/categories', { preHandler: requirePermissions(['catalog.manage']) }, async (request) => {
    ...
    app.get('/admin/categories/:id', { preHandler: requirePermissions(['catalog.manage']) }, async (request) => {
    ...
    app.post('/admin/categories', { preHandler: requirePermissions(['catalog.manage']) }, async (request, reply) => {
    ...
    app.patch('/admin/categories/:id', { preHandler: requirePermissions(['catalog.manage']) }, async (request, reply) => {
        const { id } = request.params;
        const body = request.body;
        try {
    ...
    app.delete('/admin/categories/:id', { preHandler: requirePermissions(['catalog.manage']) }, async (request, reply) => {
        const { id } = request.params;
        try {
    ...
    app.get('/admin/products', { preHandler: requirePermissions(['products.manage']) }, async (request) => {
        const query = request.query;
    ...
    app.get('/admin/products/:id', { preHandler: requirePermissions(['products.manage']) }, async (request) => {
        const { id } = request.params;
    ...
    app.patch('/admin/products/:id', { preHandler: requirePermissions(['products.manage']) }, async (request, reply) => {
        const { id } = request.params;
        const body = request.body;
        try {
            const product = await prisma.$transaction(async (tx) => {
    ...
    app.delete('/admin/products/:id', { preHandler: requirePermissions(['products.manage']) }, async (request, reply) => {
        const { id } = request.params;
        try {
    ...
    app.get('/admin/vendors', { preHandler: requirePermissions(['vendors.manage']) }, async (request) => {
        const query = request.query;
    ...
    app.get('/admin/vendors/:id', { preHandler: requirePermissions(['vendors.manage']) }, async (request) => {
        const { id } = request.params;
    ...
    app.post('/admin/vendors', { preHandler: requirePermissions(['vendors.manage']) }, async (request, reply) => {
        const body = request.body;
    ...
    app.patch('/admin/vendors/:id', { preHandler: requirePermissions(['vendors.manage']) }, async (request, reply) => {
        const { id } = request.params;
        const body = request.body;
        try {
            const vendor = await prisma.$transaction(async (tx) => {
    ...
    app.delete('/admin/vendors/:id', { preHandler: requirePermissions(['vendors.manage']) }, async (request, reply) => {
        const { id } = request.params;
        try {
    ...
    app.get('/admin/orders', { preHandler: requirePermissions(['orders.manage']) }, async (request) => {
        const query = request.query;
        const orders = await prisma.order.findMany({
            where: {
                ...(query.status ? { status: query.status.toUpperCase() } : {}),
                ...(query.paymentStatus ? { paymentStatus: query.paymentStatus.toUpperCase() } : {}),
                ...(query.q
                    ? {
                        OR: [
    ...
    app.get('/admin/orders/:id', { preHandler: requirePermissions(['orders.manage']) }, async (request) => {
        const { id } = request.params;
    ...
    app.post('/admin/orders', { preHandler: requirePermissions(['orders.manage']) }, async (request, reply) => {
        const body = request.body;
    ...
    app.patch('/admin/orders/:id', { preHandler: requirePermissions(['orders.manage']) }, async (request, reply) => {
        const { id } = request.params;
        const body = request.body;
        try {
    ...
    app.delete('/admin/orders/:id', { preHandler: requirePermissions(['orders.manage']) }, async (request, reply) => {
        const { id } = request.params;
        try {
    ...
    app.post('/admin/upload', { preHandler: requirePermissions(['products.manage']) }, async (request, reply) => {
        const body = request.body;
...
//# sourceMappingURL=admin-crud.routes.js.map